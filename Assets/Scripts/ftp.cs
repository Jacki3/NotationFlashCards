...
class ftp
{
    ...
    public void download(string remoteFile, string localFile)
    {
        try
        {
            ...
            ftpRequest =
                (FtpWebRequest) FtpWebRequest.Create(host + "/" + remoteFile);
    ...
    public void delete(string deleteFile)
    {
        try
        {
            /* Create an FTP Request */
            ftpRequest =
                (FtpWebRequest) WebRequest.Create(host + "/" + deleteFile);
    ...
    public void rename(string currentFileNameAndPath, string newFileName)
    {
        try
        {
            ...
            ftpRequest =
                (FtpWebRequest)
                WebRequest.Create(host + "/" + currentFileNameAndPath);
    ...
    public void createDirectory(string newDirectory)
    {
        try
        {
            /* Create an FTP Request */
            ftpRequest =
                (FtpWebRequest) WebRequest.Create(host + "/" + newDirectory);
    ...
    public string[] directoryListSimple(string directory)
    {
        try
        {
            /* Create an FTP Request */
            ftpRequest =
                (FtpWebRequest) FtpWebRequest.Create(host + "/" + directory);
